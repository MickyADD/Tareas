#Crear una Clase Producto con los siguientes aributos:
# -Codigo
# -Nombre
# -Precio
#  Crear, su constructor, getter y setter y una funcion llamada calcular_total,
